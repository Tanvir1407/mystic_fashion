      ...
      <div className="container mx-auto w-full overflow-hidden">
        ...
        >
          {slides.map((slide, index) => (
            <SwiperSlide key={slide.id} className="relative h-full w-full group">
        ...
        <div className="swiper-button-prev-custom absolute top-1/2 -translate-y-1/2 left-6 lg:left-28 z-20 w-9 h-9 flex items-center justify-center rounded-full border border-slate-100 text-white shadow-lg cursor-pointer hover:border-0 hover:bg-primary hover:scale-110 transition-transform">
          <svg className="w-[10px] h-4 rotate-180" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="swiper-button-next-custom absolute top-1/2 -translate-y-1/2 right-6 lg:right-28 z-20 w-9 h-9 flex items-center justify-center rounded-full border border-slate-100 text-white shadow-lg cursor-pointer hover:border-0 hover:bg-primary hover:scale-110 transition-transform">
          <svg className="w-[10px] h-4" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z" fill="currentColor" />
          </svg>
        </div>
