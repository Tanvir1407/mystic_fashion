...
export const ROUTE_PERMISSIONS = [
  ...
  { prefix: "/admin/customers", action: "VIEW", subject: "ORDERS" },
  { prefix: "/admin/purchases", action: "VIEW", subject: "PURCHASES" },
  { prefix: "/admin/suppliers", action: "VIEW", subject: "PURCHASES" },
  ...
  { prefix: "/admin/settings/audit-logs", action: "VIEW", subject: "ACTIVITY_LOGS" },
...
export function getRedirectUrlForSession(session: any): string {
  ...
  const fallbackPages = [
    ...
    { href: "/admin/odr_returns", action: "VIEW", subject: "SALES_RETURNS" },
