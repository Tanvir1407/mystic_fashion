    ...
    <div className="flex flex-col">
      ...
      <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl w-fit mb-7">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all ${activeTab === "create"
        ...
        >
          ...
          Return Logs
          <span className={`px-1.5 py-0.5 rounded-md text-[10px] font-bold ${activeTab === "logs" ? "bg-slate-100 text-slate-600" : "bg-slate-200 text-slate-500"
            }`}>
            {totalCount}
          </span>
        </button>
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center gap-3 py-3 px-4 rounded-xl border-2 transition-all text-left ${returnMode === mode
                            ? "border-[#800020] bg-[#800020]/[0.03]"
                            : "border-slate-200 hover:border-slate-300 hover:bg-slate-50"
                          }`}
                      >
                        <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 transition-all ${returnMode === mode ? "border-[#800020]" : "border-slate-300"
                          }`}>
                ...
                {selectedOrder && (
                  <div className="border-b border-slate-100 animate-in fade-in duration-200">
                    <div className="px-6 py-4 flex items-center justify-between">
                      ...
                      <span className={`text-[10px] font-semibold px-2.5 py-1 rounded-full ${returnMode === "FULL"
                      ...
                      {selectedOrder.items.map((item) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex items-center gap-4 px-6 py-4 transition-all ${returnMode === "PARTIAL" && !fullyReturned ? "cursor-pointer" : ""
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3 shrink-0">
                              <span className={`text-[10px] font-semibold px-2.5 py-1 rounded-full ${item.requiresPrint
                                  ? "bg-rose-50 text-rose-600 border border-rose-100"
                              ...
                              {returnMode === "PARTIAL" && !fullyReturned && (
                                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all ${isSelected ? "border-[#800020] bg-[#800020]" : "border-slate-300 bg-white"
                                  }`}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5">
                            ...
                            {selectedOrder.customerId && (
                              <Link href={`/admin/customers/${selectedOrder.customerId}`} target="_blank" className="text-slate-400 hover:text-[#800020] transition-colors">
                    ...
                    <div className="px-5 py-5 border-b border-slate-100 space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1.5">
                          <Link href={`/admin/orders/${selectedOrder.id}`} target="_blank" className="text-slate-400 hover:text-[#800020] transition-colors">
                            <ExternalLink className="w-3 h-3" />
                          </Link>
                      ...
                      return (
                        <tr key={ret.id} className="hover:bg-slate-50/60 transition-colors">
                          ...
                          <td className="px-6 py-4 text-center">
                            <span className={`px-2.5 py-1 rounded-full text-[10px] font-semibold ${ret.status === "RESTOCKED"
